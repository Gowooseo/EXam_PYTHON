...
# 데이터.메서드명() ==> "Good".메서드명()
#------------------------------------------------------
# str데이터에서 특정 문자의 인덱스를 반환하는 메서드 => index()
# 왼쪽----> 오른쪽, 제일 먼저 발견되는 문자의 인덱스를 반환
#-존재하지 않는 str 인덱스 찾을려고 하면 오류가 뜸.
data="Meeeerry Christmas"
#     012345678901234
print(f"data.index('C') => {data.index('C')}")
print(f"data.index('r') => {data.index('r')}")

first_r=data.index('r') #0번원소 부터 하나씩검사해서 'r'에 해당하는 인덱스 찾기
...
# 왼쪽----> 오른쪽, 제일 먼저 발견되는 문자의 인덱스를 반환
#-존재하지 않는 str 인덱스 찾을려고 하면 -1을 반환
#----------------------------------------------------------
# !의 인덱스를 찾기
print(f"data.find('!')=> {data.find('!')}")
#------------------------------------------------------
# str데이터에서 특정 문자의 인덱스를 반환하는 메서드 => split()
